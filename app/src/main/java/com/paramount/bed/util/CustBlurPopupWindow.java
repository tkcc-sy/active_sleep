...
public class CustBlurPopupWindow extends FrameLayout {
    ...
    public interface OnDismissListener {
        void onDismiss(CustBlurPopupWindow popupWindow);
    }
    ...
    public CustBlurPopupWindow(@NonNull Context context) {
        super(context);
        init();
    }
    ...
    public void show() {
        ...
        int navigationBarHeight = CustBlurPopupWindow.getNaviHeight(mActivity);
        ...
        if (animator == null) {
            ...
            animator.addListener(new AnimatorListenerAdapter() {
                ...
                private void removeSelf() {
                    try {
                        mWindowManager.removeView(CustBlurPopupWindow.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    } finally {
                        mAnimating = false;
    ...
    /**
     * When executing show method in this method, should override {@link CustBlurPopupWindow#createShowAnimator()}
    ...
    /**
     * Do not start any animation in this method. use {@link CustBlurPopupWindow#createDismissAnimator()} instead.
     */
    @CallSuper
    ...
    public static class Builder<T extends CustBlurPopupWindow> {
        private static final String TAG = "CustBlurPopupWindow.Builder";
        ...
        public Builder(Context context) {
            ...
            mBlurRadius = CustBlurPopupWindow.DEFAULT_BLUR_RADIUS;
            mScaleRatio = CustBlurPopupWindow.DEFAULT_SCALE_RATIO;
            mAnimationDuration = CustBlurPopupWindow.DEFAULT_ANIMATION_DURATION;
        }
        ...
        protected T createPopupWindow() {
            ...
            return (T) new CustBlurPopupWindow(mContext);
        }
    ...
    private final static class BlurTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private WeakReference<CustBlurPopupWindow> mPopupWindowRef;
        ...
        BlurTask(View sourceView, int statusBarHeight, int navigationBarheight, CustBlurPopupWindow popupWindow, BlurTaskCallback blurTaskCallback) {
        ...
        protected Bitmap doInBackground(Void... params) {
            ...
            CustBlurPopupWindow popupWindow = mPopupWindowRef.get();
            ...
            if(mSourceBitmap!=null && mSourceBitmap.getWidth()!=0) {
                ...
                int radius = (int) popupWindow.getBlurRadius();
                Bitmap blurred = BlurUtils.blur(context, scaledBitmap, radius);
                //Bitmap blurred = Blurry.with(context).radius(radius).from(scaledBitmap)
