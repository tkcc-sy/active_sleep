...
public final class WorkerUtils {
    public static final CharSequence VERBOSE_NOTIFICATION_CHANNEL_NAME =
            "Timer WorkManager Notifications";
    public static String VERBOSE_NOTIFICATION_CHANNEL_DESCRIPTION =
            "Shows notifications Timer starts";
    public static final CharSequence NOTIFICATION_TITLE = "Timer Starting";
    public static final String CHANNEL_ID = "TIMER_NOTIFICATION";
